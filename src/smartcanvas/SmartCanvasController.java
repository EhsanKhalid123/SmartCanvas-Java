...
//    private static Image image1 = image;
    ...
    void logout() throws IOException {
        ...
        Main.setWindow("Login", 481, 460, "Welcome to SmartCanvas!", false);
    }
    ...
    void addCanvas() throws IOException {
        Stage stage = new Stage();
        Parent root2 = FXMLLoader.load(UserDao.class.getResource("NewCanvas.fxml"));
        stage.setTitle("Create a new canvas");
        stage.setScene(new Scene(root2, 300, 145));
        stage.setResizable(false);
        Image icon = new Image(UserDao.class.getResourceAsStream("Whiteboard-512.png"));
        stage.getIcons().add(icon);
        stage.show();
    ...
    void zoom(){
        ...
        System.out.println(borderPane.getTranslateZ());
        borderPane.translateYProperty().bind(zoomSlider.valueProperty());
        borderPane.translateXProperty().bind(zoomSlider.valueProperty());
    }
